...
class shape{
    ...
    public static void main(String[] args) {
        ...
        if(snm.equals(shape.circle)){
            System.out.println("Enter radius : ");
            int r=s.nextInt();
            double p=pcircle(r);
            double a=acircle(r);
            System.err.println("The area = "+a+"/n The circumference = "+p);
        }else if(snm.equals(shape.rectangle)){
            System.out.println("Enter length and breath : ");
            int l=s.nextInt();
            int b=s.nextInt();
            double p=prect(l,b);
            double a=arect(l,b);
            System.err.println("The area = "+a+"/n perimeter = "+p);
        }else if(snm.equals(shape.square)){
            System.out.println("Enter side : ");
            int r=s.nextInt();
            double p=psqr(r);
            double a=asqr(r);
            System.err.println("The area = "+a+"/n The perimeter = "+p);
        }else if(snm.equals(shape.triangle)){
